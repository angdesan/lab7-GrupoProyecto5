...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateUI(FirebaseUser usuario){
        if (usuario != null){
            ...
            info_user.put("user_name", usuario.getDisplayName());
            info_user.put("user_email", usuario.getEmail());
            info_user.put("user_celular", usuario.getPhoneNumber());
            info_user.put("user_foto",String.valueOf(usuario.getPhotoUrl()));
            info_user.put("user_id",usuario.getUid());
            //info_user.put("user_provider",ProviderType.GOOGLE.name());
